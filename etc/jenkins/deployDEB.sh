...
echo "Depends: libc6 (>= 2.27), g++ (>= 7), gcc (>= 7), gfortran (>= 7), libgsl-dev (>=2.4), libhdf5-dev (>=1.10.0), liblapack-dev (>= 3.7), libopenmpi-dev (>=2.1.1) ,libblas-dev (>= 3.7.1) ">> $DEB_NAME/DEBIAN/control
