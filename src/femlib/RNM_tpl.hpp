...
template<class R> ostream &operator << (ostream &f, const KN_<const_R> &v) {// f <<  " KN_ : " << (ShapeOfArray) v << " "   <<  (const_R *) v << " :\n\t"  ;
	f << v.N() << "\t\n\t";
	const int i10 = 10;
	int prec = f.precision();
	if (prec < i10) f.precision(i10);
...
template<class R> ostream &operator << (ostream &f, const KNM_<const_R> &v) {	// f << " KNM_ "<<v.N()<<"x"<<v.M()<< ": " << (ShapeOfArray) v
	// << " i "  << v.shapei
	// << " j "  << v.shapej
	// << " " << &v(0,0) << " :\n\t";
	const int i10 = 10;
...
template<class R> ostream &operator << (ostream &f, const KNMK_<const_R> &v) {	// f << " KNM_" <<v.N()<<"x"<<v.M()<<"x"<<v.K()<< " : " << (ShapeOfArray) v
	// << " i "  << v.shapei
	// << " j "  << v.shapej
	// << " k "  << v.shapek << endl;
	// << " " << (void *) & v(0,0,0) << "\n\t" ;
