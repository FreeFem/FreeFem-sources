...
class E_F_F0F0F0F0F0_: public E {
	public:	// extend
...
class E_F_F0F0F0F0F0F0_: public E {
	public:	// extend
		...
		bool MeshIndependent () const {
			return E::MeshIndependent() && a0->MeshIndependent() && a1->MeshIndependent() && a2->MeshIndependent()
			       && a3->MeshIndependent() && a4->MeshIndependent() && a5->MeshIndependent();
		}	// extend aX
};
...
class E_F_F0F0F0F0F0F0F0_: public E {
	public:	// extend
...
class E_F_F0F0F0F0F0F0F0F0_: public E {
	public:	// extend
		...
		bool MeshIndependent () const {
			return E::MeshIndependent() && a0->MeshIndependent() && a1->MeshIndependent() && a2->MeshIndependent()
			       && a3->MeshIndependent() && a4->MeshIndependent() && a5->MeshIndependent() && a6->MeshIndependent() && a7->MeshIndependent();
		}	// extend aX
};
