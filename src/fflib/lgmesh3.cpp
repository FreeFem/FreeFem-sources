...
pf3r get_element (pf3rarray const &a, long const &n) {	// cout << " ************ " << n << " " << a.second << endl;
...
class MoveMesh3:  public E_F0mps {
	public:
...
class SaveSurfaceMesh3:  public E_F0 {
	public:
...
template<class K, class v_fes>
class Op4_pf32K: public quad_function<pair<FEbase<K, v_fes> *, int>, R, R, R, K> {
	public:
...
class pVh3_ndf: public ternary_function<pfes3 *, long, long, long> {
	public:
...
class Op4_Mesh32mp: public quad_function<pmesh3 *, R, R, R, MeshPoint *> {
	public:
		class Op: public E_F0mps {
			public:
				Expression a, b, c, d;
