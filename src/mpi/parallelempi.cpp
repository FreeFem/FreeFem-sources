...
template<>
class ForEachType<MPI_Group>:  public basicForEachType {
...
template<>
class ForEachType<fMPI_Comm>:  public basicForEachType {
...
template<>
class ForEachType<fMPI_Request>:  public basicForEachType {
	public:	// correction july 2009..... FH  Hoooo....  (Il y a un bug DUR DUR FH  ...)
...
fMPI_Request*get_elementp_ (KN<MPI_Request> *const &a, const long &b) {
	...
	return reinterpret_cast<fMPI_Request *>(&((*a)[b]));
}	// bofBof ...
