...
// -----------------------------ajout format hdf5-----------------------------//
		...
		if (verbosity > 1) {
			...
			switch (type) {
			case BDMesh:  cout << " BD Mesh ";
				break;
			case NOPOMesh:  cout << " NOPO ";
				break;
			case amMesh:  cout << " am ";
				break;
			case am_fmtMesh:  cout << " am_fmt ";
				break;
			case amdbaMesh:  cout << " amdba ";
				break;
			case ftqMesh:  cout << " ftq ";
				break;
			case mshMesh:  cout << " msh ";
				break;
// -----------------------------ajout format hdf5-----------------------------//
			case hdf5Mesh:  cout << " h5  ";
				break;
// -----------------------------ajout format hdf5-----------------------------//
			default:
				cerr << endl
		...
		if (f)
			...
			case NOPOMesh:  Write_nopo(f);
				break;
			case amMesh:  Write_am(f);
				break;
			case am_fmtMesh:  Write_am_fmt(f);
				break;
			case amdbaMesh:  Write_amdba(f);
				break;
			case ftqMesh:  Write_ftq(f);
				break;
			case mshMesh:  Write_msh(f);
				break;
// -----------------------------ajout format hdf5-----------------------------//
			case hdf5Mesh:  Write_hdf5(filename);
				break;
// -----------------------------ajout format hdf5-----------------------------//
			default:
