...
template <class P, class V, class M, class VM, class R>
list<int> LineSearch<P, V, M, VM, R>::allSearchIterations () { return iterHistory[0]; }

template <class P, class V, class M, class VM, class R>
int LineSearch<P, V, M, VM, R>::searchIterations () { return iterNum; }

template <class P, class V, class M, class VM, class R>
typename LineSearch<P, V, M, VM, R>::Real LineSearch<P, V, M, VM, R>::currentValue () { return value; }
