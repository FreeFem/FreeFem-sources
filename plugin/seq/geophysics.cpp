...
{ 
  if (verbosity && mpirank == 0)
    cout << " load: geophysics  " << endl;
    
  Dcl_Type<Data2D<'M'> *>(InitP<Data2D<'M'>>,Destroy<Data2D<'M'>>);
  zzzfff->Add("Marmousi",atype<Data2D<'M'>*>());
  TheOperators->Add("<-", new OneOperator2_<Data2D<'M'> *,Data2D<'M'>* ,string*>(&init_Data2D<'M'>));
  atype< Data2D<'M'> * >()->Add("(","",new OneOperator3_<double,Data2D<'M'> *,double,double>(Data2D_eval));
  Dcl_Type<Data2D<'S'> *>(InitP<Data2D<'S'>>,Destroy<Data2D<'S'>>);
  zzzfff->Add("BPSalt",atype<Data2D<'S'>*>());
  TheOperators->Add("<-", new OneOperator2_<Data2D<'S'> *,Data2D<'S'>* ,string*>(&init_Data2D<'S'>));
  atype< Data2D<'S'> * >()->Add("(","",new OneOperator3_<double,Data2D<'S'> *,double,double>(Data2D_eval));
