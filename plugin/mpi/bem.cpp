...
public:
    ...
    // Build
    virtual void build(IMatrix<K> &mat, const std::vector<htool::R3> &xt, const std::vector<double> &rt, const std::vector<int> &tabt, const std::vector<double> &gt, const std::vector<htool::R3> &xs, const std::vector<double> &rs, const std::vector<int> &tabs, const std::vector<double> &gs) = 0;
    virtual void build_sym(IMatrix<K> &mat, const std::vector<htool::R3> &xt, const std::vector<double> &rt, const std::vector<int> &tabt, const std::vector<double> &gt)  = 0;

    virtual void build_auto(IMatrix<K> &mat, double* xt, double* xs) = 0;
    virtual void build_auto_sym(IMatrix<K> &mat, double* xt)                        = 0;
...
public:
    ...
    // Build
    void build(IMatrix<K> &mat, const std::vector<htool::R3> &xt, const std::vector<double> &rt, const std::vector<int> &tabt, const std::vector<double> &gt, const std::vector<htool::R3> &xs, const std::vector<double> &rs, const std::vector<int> &tabs, const std::vector<double> &gs) {H.build(mat,xt,rt,tabt,gt,xs,rs,tabs,gs);}
    virtual void build_sym(IMatrix<K> &mat, const std::vector<htool::R3> &xt, const std::vector<double> &rt, const std::vector<int> &tabt, const std::vector<double> &gt) {H.build_sym(mat,xt,rt,tabt,gt);}

    void build_auto(IMatrix<K> &mat, double* xt, double* xs) {H.build_auto(mat,xt,xs);}
    void build_auto_sym(IMatrix<K> &mat, double* xt) {H.build_auto_sym(mat,xt);}                       
};
...
template <class R>
void builHmat(HMatrixVirt<R>** Hmat, IMatrix<R>* generatorP,string compressor,vector<double> &p1,vector<double> &p2,MPI_Comm comm)  {
    std::shared_ptr<Cluster<PCARegularClustering>> t =std::make_shared<Cluster<PCARegularClustering>>();
...
void Assembly(Matrix* A, htool::IMatrix<R>* generator, string compressor,vector<double> &p1,vector<double> &p2,MPI_Comm comm,int dim,bool = false) {
