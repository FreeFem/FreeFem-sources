...
\end{equation}
    ...
    \item[\texttt{inquire=}] To inquire about the mesh (false is the
    ...
    \itemtt[periodic=] \index{adaptmesh!periodic=} reserved for future
    use: builds an adapted periodic mesh (see periodic finite element
    spaces \ref{periodic BC})

%%%alh detail \ref{periodic BC}?
