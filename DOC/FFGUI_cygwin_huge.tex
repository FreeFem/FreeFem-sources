...
to compile FreeFem++\\
If there is an error like: ``...:  cannot find -ldl''\\
...
-$>$ make all HOSTTYPE=i-386\\
\\
At the end of compilation, a directory called ``c-i'386'' is created.\\
...
\subsection{compilation and installation of tcl8.4.0}
...
\subsection{Compilation and installation of tk8.4.0}
Go into the directory tk8.4.0/win\\
-$>$ cd tk8.4.0\\
-$>$ cd win\\
Then type :\\
-$>$ ./configure\\
