...
Mesh3 * Transfo_Mesh3(const Mesh3 & Th3, const double *tab_XX, const double *tab_YY, const double *tab_ZZ, 
	...
	SamePointElement( tab_XX, tab_YY, tab_ZZ, Th3, recollement_element, recollement_border, point_confondus_ok, 
...
Mesh3 * Transfo_Mesh2(const Mesh2 & Th2, const double *tab_XX, const double *tab_YY, const double *tab_ZZ, int &border_only){
	...
	SamePointElement_Mesh2( tab_XX, tab_YY, tab_ZZ, Th2, recollement_border, point_confondus_ok, Numero_Som, 
		ind_nv_t, ind_nt_t, ind_nbe_t, nv_t, nt_t, nbe_t);
...
void SamePointElement_Mesh2( const double *tab_XX, const double *tab_YY, const double *tab_ZZ, const Mesh & Th2, 
	...
	int & nv_t, int & nt_t,int & nbe_t ){
		...
		BuildBoundMinDist_th2( tab_XX, tab_YY, tab_ZZ, Th2, bmin, bmax, hmin);
