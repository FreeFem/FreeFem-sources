...
// S. Garnotel, april 2018
// ------------- related files:
// to check and validate: test_P2BR.edp
// to get a real example: NS_P2BR_P0.edp
...
namespace Fem2D
{
	 ...
	 * It is a 2d coupled finite element
	 * The Polynomial space is P1^2 + 3 normals bubbles edges function (P_2)
	 * The degree of freedom is 6 values of the 2 components at the 3 vertices and the 3 flux on the 3 edges
