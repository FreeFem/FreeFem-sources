...
ONETEST(array)
ONETEST(a_tutorial,u[]'*u[],1e-2)
ONETEST(beam,uu[]'*uu[],1e-2)
ONETEST(blakschol,u[]'*u[],1e-2)
ONETEST(calculus)
ONETEST(cavity,psi[]'*psi[],1e-2)
ONETEST(convect2,v[]'*v[],1e-2)
ONETEST(convect-apt,v[]'*v[],1e-2)
ONETEST(convect,v[]'*v[],1e-2)
ONETEST(dumptable)
ONETEST(ex-vf)
...
ONETEST(periodic4,uh[]'*uh[],1e-2)
ONETEST(Periodic,uh[]'*uh[],1e-2)
ONETEST(plot,uh[]'*uh[],1e-2)
ONETEST(readmesh,u[]'*u[],1e-2)
ONETEST(region,u[]'*u[],1e-2)
ONETEST(saverestore)
ONETEST(schwarz-gc,u1[]'*u1[],1e-2)
ONETEST(schwarz-no-overlap,u[]'*u[],1e-2)
ONETEST(schwarz-overlap,u[]'*u[],1e-2)
ONETEST(sparse-matrix,xx[]'*xx[],1e-2)
ONETEST(StokesUzawa,u1[]'*u1[],1e-2)
