function(ff_find_package PACKAGE)
  ...
  if(${PACKAGE}_FOUND)
    ...
    file(APPEND ${CMAKE_BINARY_DIR}/toto.inc "FREEFEM_${PACKAGE}_INCLUDE_PATHS ${INCLUDE_PATHS}\n") 
    file(APPEND ${CMAKE_BINARY_DIR}/toto.inc "FREEFEM_${PACKAGE}_LIBRARIES ${LIBRARIES}\n") 
