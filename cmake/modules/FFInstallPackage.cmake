...
IF(ENABLE_DOWNLOAD)
  ...
  MESSAGE(STATUS "${LIBRARY_UPPERNAME} : ${INCLUDE_PATHS}")
  IF (NOT INCLUDE_PATHS)
    MESSAGE(STATUS "${LIBRARY_UPPERNAME} : set include")
    SET(INCLUDE_PATHS ${FF_DOWNLOAD_DIR}/${LIBRARY_LOWERNAME}/install/include)
  ENDIF(NOT INCLUDE_PATHS)

  # set default value to LIBRARY_PATHS if not defined

  IF (NOT LIBRARY_PATHS)
    SET(LIBRARY_PATHS ${FF_DOWNLOAD_DIR}/${LIBRARY_LOWERNAME}/install/lib/)
  ...
  #SET_TARGET_PROPERTIES(FREEFEM::${LIBRARY_UPPERNAME} PROPERTIES IMPORTED_LOCATION "/home/cdoucet/Depots/ff++/download/fftw/install/lib/libfftw3.a")
  STRING(CONCAT TOTO ${LIBRARY_PATHS} ${LIBRARIES})
  MESSAGE(STATUS "FREEFEM::${LIBRARY_UPPERNAME} -> ${TOTO} -> ${INCLUDE_PATHS}")
  SET_TARGET_PROPERTIES(FREEFEM::${LIBRARY_UPPERNAME} PROPERTIES IMPORTED_LOCATION ${TOTO})
