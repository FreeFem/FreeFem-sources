...
IF(ENABLE_DOWNLOAD)
  ...
  #SET_TARGET_PROPERTIES(FREEFEM::${LIBRARY_UPPERNAME} PROPERTIES ALIASED_TARGET ${LIBRARY_LOWERNAME}) 
  ADD_DEPENDENCIES(FREEFEM::${LIBRARY_UPPERNAME} ${LIBRARY_LOWERNAME})
  #SET_TARGET_PROPERTIES(FREEFEM::${LIBRARY_UPPERNAME} PROPERTIES IMPORTED_LINK_INTERFACE_LIBRARIES ${LIBRARY_LOWERNAME}) 
